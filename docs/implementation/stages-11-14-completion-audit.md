...
Последний проверенный кодовый коммит: `4eff2ec`

После `4eff2ec` локально повторно пройдены `yarn ci:openapi`, `yarn ci:stage11`,
`yarn ci:stage12`, `yarn ci:stage13`, `yarn ci:stage14` и полный `yarn test`.
