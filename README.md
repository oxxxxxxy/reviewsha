...
| 13.1 Admin Core                    | 🟡 PARTIAL                 | Admin RBAC, overview, users/projects, queue core and HTTP role matrix are implemented; database-backed IDOR and full E2E/manual QA remain                                                        |
| 13.2 Administration                | 🟡 PARTIAL                 | Queues, logs, AI usage, statistics, filters and safe job operations are implemented; operational QA, charts and complete acceptance coverage remain                                              |
| 14.1 OpenAPI & SDK                 | 🟡 PARTIAL                 | Canonical OpenAPI generation/validation, generated types and drift check pass locally; full runtime generated-service migration and contract coverage remain                                     |
| 14.2 Frontend Integration          | 🟡 PARTIAL                 | Web/Admin share SDK client, auth/refresh and typed API layer; remaining DTO audit, query/cache coverage and critical real-API E2E remain                                                         |
