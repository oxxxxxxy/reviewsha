...
| 14.1 OpenAPI & SDK                 | 🟡 IN PROGRESS | Canonical OpenAPI generation/validation and reproducible generated SDK types are checked locally and in CI; client migration remains next |
