...
| 11.1 Chat Module                   | 🟡 IN PROGRESS | Project chat sessions, ownership, persisted history, AI context and shared Worker AI provider; full acceptance/security QA continues                                        |
...
| 13.2 Administration                | 🟡 IN PROGRESS | Queue state filters and safe job details, AI usage filters/breakdowns, server-side logs and date-filtered statistics are implemented; health/charts/failure QA remain       |
