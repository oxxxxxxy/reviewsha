...
export interface paths {
    ...
    "/reports/{id}/patched-zip": {
        ...
        /** Download the project archive with safe suggested patches applied */
        get: operations["Reports_patchedZip"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/chat/{sessionId}/patched-zip": {
        ...
        get?: never;
        put?: never;
        /** Download a project archive with chat-proposed patches applied */
        post: operations["Chat_patchedZip"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/admin/users/{id}/details": {
        ...
        /** Get an administrative user detail summary */
        get: operations["Admin_userDetails"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/admin/projects/{id}/details": {
        ...
        /** Get an administrative project detail summary */
        get: operations["Admin_projectDetails"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/admin/projects": {
        ...
        /** List all projects for administration */
        get: operations["Admin_projects"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/admin/projects/{id}": {
        ...
        /** Get an administrative project */
        get: operations["Admin_project"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/admin/ai/settings": {
        ...
        /** Get editable AI gateway settings with a masked API key */
        get: operations["Admin_aiSettingsView"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
        /** Update AI gateway, model and runtime settings */
        patch: operations["Admin_updateAiSettings"];
        trace?: never;
    };
    "/admin/ai/models": {
        parameters: {
        ...
        /** List models exposed by the configured OmniRoute gateway */
        get: operations["Admin_aiModels"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/admin/ai/test-connection": {
        ...
        get?: never;
        put?: never;
        /** Test the configured OmniRoute gateway connection */
        post: operations["Admin_testAiConnection"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        ChatPatchDto: {
            /** @example src/auth/service.ts */
            filePath: string;
            before: string;
            after: string;
        };
        ChatPatchZipDto: {
            patches: components["schemas"]["ChatPatchDto"][];
        };
        ...
        AdminUpdateUserDto: {
            /** @example Updated Developer */
            displayName?: string;
            /** @example https://cdn.reviewsha.local/avatar.png */
            avatarUrl?: string;
            /** @example false */
            isActive?: boolean;
            /**
        ...
        AdminProjectDetailsResponseDto: {
            ...
            versions: components["schemas"]["AdminProjectVersionDto"][];
            analyses: components["schemas"]["AdminProjectAnalysisDto"][];
        };
        ...
        UpdateAdminAiSettingsDto: {
            ...
            /** @example auto/best-coding */
            model?: string;
            /** @description A new key. It is encrypted at rest and never returned. */
            apiKey?: string;
            /** @example false */
            clearApiKey?: boolean;
            /** @example 6000 */
        ...
        AdminAiConnectionResponseDto: {
            /** @example true */
            ok: boolean;
            /** @example OmniRoute is reachable */
            message: string;
            /** @example 28 */
            modelsCount: number;
            /** @example 342 */
...
export interface operations {
    ...
    Chat_patchedZip: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ChatPatchZipDto"];
            };
        };
        responses: {
            201: {
    ...
    Admin_userDetails: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AdminUserDetailsResponseDto"];
                };
            };
            /** @description Bad request. */
            400: {
    ...
    Admin_projectDetails: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AdminProjectDetailsResponseDto"];
                };
            };
            /** @description Bad request. */
            400: {
    ...
    Admin_aiSettingsView: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AdminAiSettingsResponseDto"];
                };
            };
            /** @description Bad request. */
            400: {
    ...
    Admin_updateAiSettings: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["UpdateAdminAiSettingsDto"];
            };
        };
        responses: {
            200: {
    ...
    Admin_aiModels: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AdminAiModelsResponseDto"];
                };
            };
            /** @description Bad request. */
            400: {
    ...
    Admin_testAiConnection: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AdminAiConnectionResponseDto"];
                };
            };
            /** @description Bad request. */
            400: {
